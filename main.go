...
// AppDependencies contains application dependencies for clean architecture.
type AppDependencies struct {
	TelemetryConfig telemetry.Config
}

// SetupApp initializes and configures the Fiber application with OpenTelemetry middleware.
...
func registerRoutes(app *fiber.App) {
	...
	// Telemetry Demo endpoint GET /api/v1/telemetry-demo
...
func handleTelemetryDemo(c *fiber.Ctx) error {
	...
	// Child Span 1: Simulated Database Call
	...
	// Child Span 2: Simulated External API Call
...
func main() {
	...
	// 1. Initialize OpenTelemetry Provider (Azure / OTLP / Stdout)
	...
	go func() {
		<-shutdownChan
		log.Println("[Server] Gracefully shutting down HTTP server...")
